...
DECLARE BRAND_CODE STRING DEFAULT 'VD';  -- 베르다 브랜드
...
-- 리오더 가능 품번 목록 (verda_master 기준) + vendor_category 포함
...
-- 베르다 브랜드 실시간 재고 (stockDetail_raw 사용, verda_master에 있는 품번만)
